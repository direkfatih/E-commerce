      ...
      <Form name="basic" layout="vertical" onFinish={onFinish} form={form}>
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Bir ürün açıklaması giriniz",
            },
          ]}
        >
          <ReactQuill
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "En az 4 tane ürün görsel linki giriniz",
            },
          ]}
        >
          <Input.TextArea
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "En az bir tane ürün rengi giriniz",
            },
          ]}
        >
          <Input.TextArea
            placeholder="Her bir renk kodunu yeni bir satıra yazınız..."
            autoSize={{ minRows: 4 }}
          />
        </Form.Item>
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "En az bir tane ürün beden ölçüsü giriniz",
            },
          ]}
        >
          <Input.TextArea
